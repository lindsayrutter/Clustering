...
1) DU vs DR with calcNormFactors and no filtering
  - TopDEG_DU_DR_NoFilter_CalcNorm.csv
  - DU_DR_Genes_NoFilter_CalcNorm/
2) DU vs DR with calcNormFactors and cpm filtering
  - TopDEG_DU_DR_Filter_CalcNorm.csv
  - DU_DR_Genes_Filter_CalcNorm/
3) DU vs DR with calcNormFactors and cpm and Loess filtering
  - TopDEG_DU_DR_Filter_Loess_CalcNorm.csv
  - DU_DR_Genes_Filter_Loess_CalcNorm/
...
for (i in 1:100){
  ...
  jpeg(file = paste(getwd(), "/DU_DR_Genes_NoFilter_CalcNorm/", "Gene_", i, ".jpg", sep=""), height = 700, width = 700)
  print(genePlot)
  dev.off()
}
@
...
<<eval=TRUE>>=
write.csv(tt$table, file="TopDEG_DU_DR_Filter_CalcNorm.csv")
@
...
for (i in 1:100){
  ...
  jpeg(file = paste(getwd(), "/DU_DR_Genes_Filter_CalcNorm/", "Gene_", i, ".jpg", sep=""), height = 700, width = 700)
  print(genePlot)
  dev.off()
}
@
...
for (i in 1:100){
  ...
  jpeg(file = paste(getwd(), "/DU_DR_Genes_Filter_Loess_CalcNorm/", "Gene_", i, ".jpg", sep=""), height = 700, width = 700)
  print(genePlot)
  dev.off()
}
@
